...
```bash
SKILL_PATH="${CODEX_HOME:-$HOME/.codex}/skills/design-verify-ios/SKILL.md"
[ -f "$HOME/.claude/skills/design-verify-ios/SKILL.md" ] && SKILL_PATH="$HOME/.claude/skills/design-verify-ios/SKILL.md"
[ -f "$HOME/.Codex/skills/design-verify-ios/SKILL.md" ] && SKILL_PATH="$HOME/.Codex/skills/design-verify-ios/SKILL.md"
