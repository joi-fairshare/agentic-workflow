...
allowed-tools: Bash(git *), Bash(source ~/.claude/skills/*), Bash(source ~/.codex/skills/*), Bash(source ~/.Codex/skills/*), Read, Glob, AskUserQuestion
---
...
```bash
SKILL_PATH="${CODEX_HOME:-$HOME/.codex}/skills/verify-ios/SKILL.md"
[ -f "$HOME/.claude/skills/verify-ios/SKILL.md" ] && SKILL_PATH="$HOME/.claude/skills/verify-ios/SKILL.md"
[ -f "$HOME/.Codex/skills/verify-ios/SKILL.md" ] && SKILL_PATH="$HOME/.Codex/skills/verify-ios/SKILL.md"
