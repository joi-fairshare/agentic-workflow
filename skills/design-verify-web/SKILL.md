...
```bash
SKILL_PATH="${CODEX_HOME:-$HOME/.codex}/skills/verify-web/SKILL.md"
[ -f "$HOME/.claude/skills/verify-web/SKILL.md" ] && SKILL_PATH="$HOME/.claude/skills/verify-web/SKILL.md"
[ -f "$HOME/.Codex/skills/verify-web/SKILL.md" ] && SKILL_PATH="$HOME/.Codex/skills/verify-web/SKILL.md"
SKILL_DIR="$(dirname "$(readlink -f "$SKILL_PATH")")"
